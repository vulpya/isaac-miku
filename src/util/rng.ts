 ...
 */
const luckBonus = (luck: float): float => luck * 2;
 ...
 * ```
 */
const getRandomPercent = (rng: RNG): int => getRandomFloat(0, 100, rng);
 ...
 *
 * ### Notes
 * - Expects a roll value typically generated by {@link getRandomPercent}.
...
export const rollChance = (
  ...
  rng: RNG,
  luck: float = 0,
): boolean => getRandomPercent(rng) < calcChance(percent, luck, true);
